...
export class ConfigService {
	...
	get mongoURL() {
		return (
			...
			`mongodb://${process.env.QOVERY_DB_ZFAD4D02D_LOGIN}:${process.env.QOVERY_DB_ZFAD4D02D_PASSWORD}@${process.env.QOVERY_DB_ZFAD4D02D_HOST}.qovery.io:${process.env.QOVERY_DB_ZFAD4D02D_PORT}` ||
			''
		);
	}
